...
const csp = [
  `default-src 'self'`,
  `script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://*.vercel-insights.com https://va.vercel-scripts.com https://*.zohopublic.in https://*.zohocdn.com`,
  ...
  `connect-src 'self' https://api.groq.com https://*.public.blob.vercel-storage.com https://sarvadnya-infotech.vercel.app https://*.vercel-insights.com https://*.zohopublic.in wss://*.zohopublic.in https://*.zohocdn.com`,
