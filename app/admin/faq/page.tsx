        ...
        {CATEGORY_OPTIONS.map(category => {
          ...
          return (
            <div key={category} className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 bg-[#F5F4ED] border-b border-[#E5F4F4]">
                <div className="flex items-center gap-3">
                  <h2 className="text-lg font-black text-[#006569]">{category}</h2>
                  <span className="px-2.5 py-0.5 rounded-full bg-[#E5F4F4] text-[#006569] text-[10px] font-black uppercase tracking-widest">
                    ...
                    return (
                      <div key={globalIdx} className="p-6 space-y-4 relative group hover:bg-slate-50/50 transition-colors">
                        ...
                        <div className="pr-10">
                          ...
                          <input
                            className="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-[#006569] font-bold text-slate-800"
                        ...
                        <div>
                          ...
                          <textarea
                            className="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-[#006569] h-24 text-slate-600 leading-relaxed"
                ...
                return (
                  <div key={globalIdx} className="p-6 space-y-4 relative group hover:bg-slate-50/50 transition-colors">
                    ...
                    <div>
                      ...
                      <select
                        className="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-[#006569] font-medium text-slate-700"
                        value={faq.category || ''}
