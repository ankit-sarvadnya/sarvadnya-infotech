  ...
  return (
    <div className="min-h-screen bg-[#ecf5fa] py-20 px-6">
      <div className="max-w-4xl mx-auto bg-white rounded-[32px] p-10 md:p-16 shadow-sm border border-slate-100">
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">TallyPrime Silver</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-slate-50 p-8 rounded-3xl">
                ...
                <ul className="space-y-4 text-slate-700 font-medium text-sm">
                    <li>✓ Complete GST compliance including e-invoicing</li>
                    <li>✓ Comprehensive inventory management</li>
                    <li>✓ Lifetime license with easy upgrades</li>
