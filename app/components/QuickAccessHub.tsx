    ...
    <section id="quick-access-hub" className="w-full bg-white py-16 md:py-24 px-5 border-y border-slate-100 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-[1000ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#006569] block mb-4">
            Ecosystem Directory
          </span>
          <h2 className="text-3xl lg:text-5xl font-black text-[#232F3E] tracking-tighter mb-4 leading-tight">
            Quick Access <span className="text-[#006569]">Hub</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, idx) => (
            <Link 
              key={idx} 
              href={card.href}
              className={`group relative flex flex-col bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm transition-all duration-[1000ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:shadow-2xl hover:shadow-[#006569]/10 hover:-translate-y-2 hover:border-[#006569]/30
            ...
            >
              {/* Top border shine */}
              <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-transparent via-[#006569]/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-t-[2rem]" />
              {/* Icon Container */}
              ...
              <div className="flex-1">
                <h3 className="text-xl font-black text-[#232F3E] tracking-tight mb-3 group-hover:text-[#006569] transition-colors uppercase text-[15px]">
                  {card.title}
                </h3>
              ...
              {/* Action Indicator */}
              <div className="mt-8 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:text-[#006569] transition-colors">
                Explore Page
        ...
        <div className={`mt-20 text-center transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
           <Link 
            href="/contact"
            className="inline-flex h-14 px-12 items-center justify-center rounded-full bg-[#006569] text-white font-black text-[11px] uppercase tracking-wider border border-transparent hover:bg-white hover:text-[#006569] hover:border-[#006569] transition-all duration-500 ease-in-out hover:scale-[1.05] active:scale-95 shadow-2xl shadow-[#006569]/20"
          >
