      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="grid grid-cols-2 gap-2 mb-5">
          <a
            ...
            className="flex items-center justify-center gap-1.5 py-2 rounded-xl bg-slate-50 text-slate-600 text-[10px] font-bold hover:bg-[#006569] hover:text-white transition-all border border-slate-100"
          >
