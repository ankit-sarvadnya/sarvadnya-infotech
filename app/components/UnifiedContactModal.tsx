    ...
    <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-[#0f0529]/60 backdrop-blur-md animate-in fade-in duration-300" onClick={onClose}>
      ...
      >
        ...
        <div className="bg-white sm:p-6 p-6 md:p-8 lg:p-4 text-slate-900 relative overflow-hidden border-b border-slate-100">
          <div className="absolute top-0 right-0 w-32 h-32 bg-teal-50 rounded-full blur-[60px] opacity-60 -mr-16 -mt-16" />
          ...
          <div className="relative z-10">
            ...
            <p className="mt-1.5 sm:mt-2 text-[11px] md:text-xs text-slate-500 leading-relaxed font-medium">
              Fill in the details below and our team will get back to you within <span className="text-[#006569] font-bold">15 minutes</span>.
            </p>
          </div>
        </div>
        ...
        <div className="sm:p-6 p-6 md:p-8 lg:p-4 bg-slate-50/50">
          {isSuccess ? (
            <div className="py-6 sm:py-8 text-center animate-in fade-in zoom-in-95 duration-500">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-inner">
            ...
            <form onSubmit={handleSubmit} className="sm:space-y-4 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl bg-white border border-slate-200 px-4 py-2 sm:py-2.5 text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-[#006569]/20 focus:border-[#006569] transition-all shadow-sm"
                  />
                </div>
                <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full rounded-xl bg-white border border-slate-200 px-4 py-2.5 sm:py-3 text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-[#006569]/20 focus:border-[#006569] transition-all shadow-sm resize-none"
                />
              </div>
