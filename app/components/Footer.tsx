...
export default function Footer() {
    ...
    const socialLinks = [
        ...
        { name: 'Facebook', url: settings?.facebook_url || process.env.NEXT_PUBLIC_FACEBOOK_URL || '#', hoverColor: 'hover:bg-[#1877F2] hover:border-[#1877F2]', icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
        )},
        { name: 'Instagram', url: settings?.instagram_url || process.env.NEXT_PUBLIC_INSTAGRAM_URL || '#', hoverColor: 'hover:bg-[#E4405F] hover:border-[#E4405F]', icon: (
        ...
        { name: 'LinkedIn', url: settings?.linkedin_url || process.env.NEXT_PUBLIC_LINKEDIN_URL || '#', hoverColor: 'hover:bg-[#0077B5] hover:border-[#0077B5]', icon: (
