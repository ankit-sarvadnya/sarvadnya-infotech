...
const Productbar = ({ initialSettings }: { initialSettings?: any }) => {
  ...
  return (
    <div 
      className={`w-full border-b border-[#E5E2D9] relative z-30 flex items-center no-scrollbar transition-opacity duration-300 ease-in-out shadow-sm bg-[linear-gradient(90deg,rgba(249,251,245,1)_0%,rgba(244,242,234,1)_53%,rgba(238,236,223,1)_100%)] h-7 lg:h-10
