...
export default function NewsFeed({ initialData }: { initialData?: NewsItem[] }) {
  ...
  return (
    <div
      className="relative w-full bg-[#006569] h-[20px] flex items-center border-b border-white/10 group overflow-visible z-[2100]"
    >
      {/* Label Section */}
      <div className="absolute left-0 top-0 bottom-0 z-[1010] flex items-center bg-gradient-to-r from-[#006569] via-[#006569] to-transparent px-6 pr-12 pointer-events-none">
      ...
      {currentNews && (
        ...
        >
          <div className="relative">
            ...
            <Link
              href="/news"
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#006569] text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-[#045A57] transition-all shadow-lg shadow-teal-100"
            >
              Read Full Story
