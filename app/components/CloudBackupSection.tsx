        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 leading-[1.1] tracking-tighter mb-6">
                Reliable Cloud & <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#006569] to-[#006569]">Zero-Loss Backup</span>
              </h2>
            ...
            <div className="grid grid-cols-1 gap-8">
              {features.map((f, i) => (
                <div key={i} className="group flex gap-6 p-6 rounded-[2rem] border border-slate-100 bg-slate-50/30 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500">
                  <div className="w-14 h-14 shrink-0 rounded-2xl bg-white border border-slate-100 flex items-center justify-center text-[#006569] shadow-sm group-hover:scale-110 transition-transform">
                    {f.icon}
                  </div>
                  <div>
                    <div className="flex items-center gap-3 mb-1">
                      <h3 className="text-lg font-black text-slate-900 tracking-tight">{f.title}</h3>
                      <span className="text-[9px] font-black uppercase px-2 py-0.5 rounded-full bg-[#E9F1FA] text-[#006569] tracking-widest">{f.tag}</span>
                    </div>
          ...
          <div className="relative">
            <div className="relative aspect-square w-full max-w-[540px] mx-auto">
              ...
              {/* Decorative Blur */}
              <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-[#006569]/10 via-[#006569]/5 to-transparent rounded-full blur-3xl pointer-events-none" />
