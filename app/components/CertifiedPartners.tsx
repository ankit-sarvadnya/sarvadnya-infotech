...
const CertifiedPartners = ({ initialData }: { initialData?: Partner[] }) => {
    ...
    return (
        <section 
            id="partners-section"
            className="w-full py-16 md:py-24 bg-[linear-gradient(90deg,_rgba(249,251,245,1)_0%,_rgba(244,242,234,1)_53%,_rgba(238,236,223,1)_100%)] border-y border-[#E9F1FA] overflow-hidden"
        >
