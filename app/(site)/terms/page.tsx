  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <section className="bg-[#f0f8fa] pt-12 pb-16 px-6 text-center relative overflow-hidden flex flex-col items-center border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full flex flex-col items-center">
          <h1 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 leading-tight tracking-tight">
            Terms & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A6E62] via-[#5D887A] to-[#4A6E62] drop-shadow-[0_2px_15px_rgba(93,136,122,0.3)]">Conditions</span>
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-10 text-slate-600 leading-relaxed font-medium">
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900 mb-4 uppercase tracking-tight text-[#4A6E62]">2. Product Availability</h2>
          <p className="bg-[#F5F4ED] p-6 rounded-2xl border border-[#4A6E62]/10 text-slate-900 font-bold">
