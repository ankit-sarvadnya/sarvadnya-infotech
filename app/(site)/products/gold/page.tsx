      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <ol className="flex items-center gap-1.5 py-2.5 text-xs font-medium text-slate-500">
            ...
            <li className="text-slate-300" aria-hidden="true">/</li>
            <li className="text-slate-800 font-semibold" aria-current="page">TallyPrime Gold</li>
          </ol>
        </div>
      </nav>
            ...
            <section className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">Network</h3>
                    <div className="flex flex-wrap gap-2">
                      {['Office LAN', 'Wi-Fi Network'].map((net) => (
                        <span key={net} className="inline-flex rounded-md px-2.5 py-1 text-xs font-medium text-slate-600 bg-slate-50 border border-slate-200">
                          {net}
                        </span>
                      ))}
                    </div>
          ...
          <div className="lg:col-span-4 xl:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              <div className="px-5 py-4 bg-[#045A57]">
                <h3 className="text-sm font-bold text-white">Get Best Quote for TallyPrime Gold</h3>
