      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <ol className="flex items-center gap-1.5 py-2.5 text-xs font-medium text-slate-500">
            ...
            <li className="text-slate-300" aria-hidden="true">/</li>
            <li className="text-slate-800 font-semibold" aria-current="page">TallyPrime Server</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 xl:col-span-9 space-y-6">
            ...
            <section className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Windows Server 2016+', 'Windows 10 Pro', 'Windows 11 Pro'].map((os) => (
                        <span key={os} className="inline-flex rounded-md px-2.5 py-1 text-sm font-medium border border-[#006569]/25 bg-[#006569]/5 text-[#006569]">
                          {os}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">Network Setup</h3>
                    <div className="flex flex-wrap gap-2">
                      {['Local Area Network (LAN)', 'VPN for Branch Offices'].map((net) => (
                        <span key={net} className="inline-flex rounded-md px-2.5 py-1 text-sm font-medium text-slate-600 bg-slate-50 border border-slate-200">
                          {net}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">Virtual Environments</h3>
                    <div className="flex flex-wrap gap-2">
                      {['Cloud (TVU Required)', 'RDP (TVU Required)', 'Citrix (TVU Required)'].map((env) => (
                        <span key={env} className="inline-flex rounded-md px-2.5 py-1 text-sm font-medium border border-[#d97706]/25 bg-[#d97706]/5 text-[#d97706]">
                          {env}
                        </span>
                      ))}
                    </div>
            ...
            <section id="pricing" className="scroll-mt-16 bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
              ...
              <div className="rounded-lg border border-slate-200 p-4 sm:p-6 text-center">
                <div className="size-12 mx-auto rounded-full flex items-center justify-center mb-4 bg-[#006569]/10">
                  <svg className="size-6 text-[#006569]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition-all bg-[#006569] hover:bg-[#045A57] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#006569] focus-visible:ring-offset-2"
                >
                  Contact Sales
                  <svg className="size-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <div className="lg:col-span-4 xl:col-span-3 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              <div className="px-5 py-4 bg-[#045A57]">
                <h3 className="text-sm font-bold text-white">Upgrade Your Infrastructure</h3>
