...
export const SEMANTIC_INDEX: SemanticMapping[] = [
  ...
  },
  {
    ...
    target: {
      ...
      description: 'Explore TallyPrime Silver (Single User), Gold (Multi-User), and Server editions. Get a professional quote for your business requirements.',
      url: '/products',
      type: 'Page',
  ...
  },
  {
    ...
    target: {
      ...
      description: 'Enterprise edition for shared data access, higher concurrency, hidden data folders, and advanced user logs.',
      url: '/products/server',
      type: 'Page',
