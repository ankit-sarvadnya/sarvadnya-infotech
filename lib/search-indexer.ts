...
export const SEMANTIC_INDEX: SemanticMapping[] = [
  ...
  },
  {
    ...
    target: {
      title: 'TallyPrime Pricing & Products',
      description: 'Explore TallyPrime Silver (Single User), Gold (Multi-User), and Server products. Get a professional quote for your business requirements.',
      url: '/products',
      type: 'Page',
  ...
  {
    keywords: ['server', 'tallyprime server', 'enterprise server', '50+ users', 'multi-user server', 'shared data'],
    target: {
      title: 'TallyPrime Server',
      description: 'Enterprise product for shared data access, higher concurrency, hidden data folders, and advanced user logs.',
      url: '/products/server',
      type: 'Page',
